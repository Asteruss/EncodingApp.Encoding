...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest encodingapp.web.client -- --template=react  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`encodingapp.web.client.esproj`).
